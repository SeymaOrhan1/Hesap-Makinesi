...
for i in range(1,10):
    b.append(Button(text=str(i),font="Verdana 14 ",command=lambda x=i:yaz(x)))
...
sb = Button(text="0",font="Verdana 14",command=lambda x=0:yaz(x))
sb.place(x=20,y=200)

nb = Button(text=".",font="Verdana 14",width=2,command=lambda x=".":yaz(x))
nb.place(x=70,y=200)

eb = Button(text="=",fg ="RED",font="Verdana 14",command=hesapla)
